        ...
        <div className="max-w-[1800px] mx-auto px-6 md:px-12">
          <div className="min-h-screen flex flex-col justify-center items-center relative py-20">
            <ScrollTriggerAnimation className="text-center w-full">
              <h1 className="text-[14vw] sm:text-9xl md:text-[11rem] lg:text-[13rem] font-black text-white mb-8 italic tracking-tighter uppercase leading-[0.8]">
                BMC{" "}
              ...
              <p className="text-gray-400 text-lg md:text-2xl max-w-3xl mx-auto mb-16 font-medium tracking-wide px-4">
                ...
                <span className="text-orange-500 font-black italic ml-2">GOLDEN HOUR</span>
                <span className="mx-6 text-white/10 hidden md:inline">|</span>
                <span className="text-blue-400 font-black italic">MOODY</span>
              </p>
              ...
              <div className="flex items-center justify-center w-full max-w-2xl lg:max-w-4xl mx-auto mb-12 px-4">
                ...
                <div className="mx-8 rotate-45 w-5 h-5 border-2 border-white/40 flex-shrink-0 bg-white/5" />
            ...
            {/* AQUÍ ESTÁ TU FLECHA ANIMADA QUE HABÍA DESAPARECIDO */}
